...
; ------------------------------------------------------------------------------
LF5F0               lda       $0086               ; load bits value
...
; ------------------------------------------------------------------------------
LF658               lda       coolantTempCount    ; load ECT sensor count
...
; ------------------------------------------------------------------------------
LF7F0               lda       faultBits_4B        ; load fault bits
...
; ------------------------------------------------------------------------------
CalcIacvVariable    ldb       #$80                ; inital value for iacvVariable
