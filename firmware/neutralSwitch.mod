...
adcRoutine5         sta       neutralSwitchVal    ; this is compared elsewhere with $4D and $B3
                    ldb       $0085
...
.LD350              orb       #$30                ; set X008A.5 and X008A.4
                    bra       .LD370              ; store X008A and return

.LD354              ldb       $008A               ; if here, X0085.1 is set
