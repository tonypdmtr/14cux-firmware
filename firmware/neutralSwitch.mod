...
adcRoutine5         proc
                    sta       neutralSwitchVal    ;this is compared elsewhere with $4D and $B3
                    ldb       $0085
                    ...
                    bcc       _1@@                ;branch if reading GT $B3 (auto in drive)
          ;-------------------------------------- ;if here, auto in park or manual
                    andb      #$CF                ;clr X008A.5 and X008A.4
                    orb       #$10                ;set X008A.4
                    bra       Save@@              ;store X008A and return
          ;-------------------------------------- ;if here, auto in drive
_1@@                orb       #$30                ;set X008A.5 and X008A.4
                    bra       Save@@              ;store X008A and return

_2@@                ldb       $008A               ;if here, X0085.1 is set
                    andb      #$30                ;isolate X008A.5 and X008A.4
                    cmpa      #$B3                ;compare ADC value with $B3
                    bcc       _3@@                ;branch ahead if >= $B3

                    cmpb      #$30                ;test X008A.5 and X008A.4
                    bne       Done@@              ;return if not zero

                    ldb       $008A               ;load bits value again
                    andb      #$CF                ;clr X008A.5 and X008A.4
                    bra       Save@@              ;store X008A and return

_3@@                cmpb      #$10                ;cmpr 008A for xx01 xxxx
                    bne       Done@@
                    ldb       $008A
                    orb       #$20                ;set 008A.5
                    andb      #$EF                ;clr 008A.4

Save@@              stb       $008A               ;store X008A
Done@@              rts                           ;return
