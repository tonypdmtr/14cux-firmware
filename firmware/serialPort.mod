...
.LF9DC              jmp       ,x                  ;jump to sciRoutine1 + Index
...
.was.FA31           ldd       ,x                  ;load 16-bit qty from indexed loc
...
;*** RE-ENTRY POINT FOR MULTIPLE READ ***
                    ...
                    lda       ,x                  ;xmt bfr ptr = 00E9/EA, get char
