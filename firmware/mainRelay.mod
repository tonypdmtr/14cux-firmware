...
CalcVoltageAdj@@    stb       $008B               ;store X008B
                    ...
                    bne       _1@@                ;branch ahead if bit is high

                    lda       $00CA               ;reload A
                    subd      mainVoltageAdj      ;subtract voltage ajustment
                    bcs       DecVoltAdjust@@     ;branch if A is less

                    ldd       mainVoltageAdj
                    incd                          ;increment main voltage adjustment value
                    bra       Save@@

DecVoltAdjust@@     ldd       mainVoltageAdj      ;load main voltage adjustment
                    decd                          ;decrement it by 1
                    bra       Save@@              ;and store it back

_1@@                ldd       $00CA               ;load 16-bit value from X00CA/CB

Save@@              std       mainVoltageAdj      ;store as main voltage adjustment
                    rts
