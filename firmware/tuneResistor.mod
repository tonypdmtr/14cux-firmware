...
adcRoutine10        proc
                    ...
                    ldb       #$05                ;else...
                    stb       fuelMapNumber       ;load 5 as fuel map
...
.LD571              lda       $0085               ;X0085.7 indicates no or low eng RPM (eng not running)
          ...
          ;-------------------------------------- ;Engine is running
                    ...
                    lda       fuelMapNumber       ;else, compare fuel map number
                    cmpa      fuelMapNumberBackup  ;with value saved in battery-backed memory (X0050)
                    bne       .LD593

                    lda       bits_2038           ;if here, fuel map numbers match
                    ora       #$04                ;set bits_2038.2
                    sta       bits_2038
...
.LD593              lda       tuneResistorDelay   ;load fault 21 delay counter
                    ...
                    sta       tuneResistorDelay   ;store it
                    lda       bits_2038
