...
adcRoutine4         proc
                    tab                           ;xfer ECT reading from A to B
...
.LD16E              bitb      #$01                ;test X0085.0
          ...
          ;-------------------------------------- ;comes here when eng RPM is LT 505 and 0085.0 is clr
...
.LD18C              andb      #$7F                ;clr 0085.7 (eng spd GT 505 or 375)
                    stb       $0085
                    rts
          ;-------------------------------------- ;branch here when fuel pump is OFF
.LD191              lda       bits_2047
...
.LD1CF              jsr       driveIacMotor       ;stepper motor routine
          ...
          ;--------------------------------------
.LD1F3              ldb       $0085
          ;-------------------------------------- ;comes here if RPM < 505 and X0085.0 is set
