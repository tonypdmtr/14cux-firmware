...
_2@@                ldb       $00DD
                    ...
                    tsta                          ;A accum is 8-bit ADC reading
                    bmi       _3@@                ;branch ahead if ADC reading is high (heater OFF)
          ;-------------------------------------- ;Screen Heater is ON    (X0085.1 was 1)
                    cmpb      #$06                ;<-- heater is ON
                    bne       Done@@              ;rtn if not xxxxx11x
                    ldb       $00DD
                    andb      #$F9                ;set X00DD to xxxx x00x
                    bra       _4@@                ;branch to store and return
          ;-------------------------------------- ;Screen Heater is OFF   (X0085.1 was 1)
                                                  ;<-- heater is OFF
_3@@                cmpb      #$02                ;test for xxxx x01x
                    bne       Done@@              ;rtn if not equal
                    ldb       $00DD
                    orb       #$04
                    andb      #$FD                ;set X00DD to xxxx x10x
_4@@                stb       $00DD               ;store X00DD
Done@@              rts
