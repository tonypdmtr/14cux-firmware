...
simulation2         proc
                    lda       $2072               ;[4] check the value that turns sim on/off
                    cmpa      #$55                ;[2] $55 turns it on
                    bne       Done@@              ;[3] return if not $55
...
o2Simulation        proc
Done@@              equ       :AnRTS              ;(to match original code else it could be our own RTS)
                    ldb       $2072               ;[4]
                    cmpb      #$55                ;[2]
                    bne       Done@@              ;[3]
